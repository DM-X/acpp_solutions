...
badd +0 ref_handle.hpp
badd +0 ref_handle.cpp
argglobal
silent! argdel *
argadd core.hpp
set stal=2
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 75 - ((54 * winheight(0) + 34) / 69)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
75
normal! 014|
lcd ~/OneDrive/acpp/acpp_14_0_c
tabedit ~/OneDrive/acpp/acpp_14_0_c/Makefile
set splitbelow splitright
wincmd t
set winheight=1 winwidth=1
argglobal
