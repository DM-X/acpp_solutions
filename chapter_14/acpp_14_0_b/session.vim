...
badd +0 student_info.hpp
badd +0 student_info.cpp
badd +0 ~/OneDrive/acpp/acpp_13_0_b/main.cpp
argglobal
silent! argdel *
argadd core.hpp
set stal=2
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 52 - ((51 * winheight(0) + 34) / 69)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
52
normal! 0
lcd ~/OneDrive/acpp/acpp_14_0_b
tabedit ~/OneDrive/acpp/acpp_14_0_b/Makefile
set splitbelow splitright
wincmd t
set winheight=1 winwidth=1
argglobal
