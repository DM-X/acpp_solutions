...
imap #cpp /*Author: Daniel MaierDate: =strftime("%a %d %b %Y %H:%M:%S (%Z)")Program description:*/#include <iostream>#include <string>#include <vector>using std::cout;using std::endl;using std::string;using std::vector;int main(int argc, char** argv){return 0;}
imap #c /*Author: Daniel MaierDate: /2019Program description:*/#include <stdio.h>int main(int argc, char** argv){return 0;}
...
set guicursor=n-v-c:block-Cursor/lCursor,ve:ver35-Cursor,o:hor50-Cursor,i-ci:ver25-Cursor/lCursor,r-cr:hor20-Cursor/lCursor,sm:block-Cursor-blinkwait175-blinkoff150-blinkon175,n-v-c:blinkon1
set helplang=en
set hlsearch
...
badd +1 ptr.hpp
badd +1 picture.hpp
badd +1 frame_pic.hpp
badd +1 pic_base.hpp
badd +1 vcat_pic.hpp
badd +1 hcat_pic.hpp
badd +1 string_pic.hpp
badd +1 hcat.hpp
badd +1 vcat.hpp
badd +1 frame.hpp
badd +1 picture.cpp
badd +1 string_pic.cpp
badd +1 vcat_pic.cpp
badd +1 hcat_pic.cpp
badd +1 frame_pic.cpp
argglobal
silent! argdel *
set stal=2
edit main.cpp
