...
badd +0 grad.cpp
badd +0 Makefile
badd +0 student_calc.hpp
badd +0 student_calc.cpp
badd +0 ~/OneDrive/acpp/acpp_9_7/student.cpp
argglobal
silent! argdel *
argadd core.hpp
set stal=2
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 48 - ((47 * winheight(0) + 34) / 69)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
48
...
1
normal! 0
tabedit ~/OneDrive/acpp/acpp_9_7/student.cpp
set splitbelow splitright
wincmd t
set winheight=1 winwidth=1
argglobal
...
23
normal! 0
lcd ~/OneDrive/acpp/acpp_13_0
tabedit ~/OneDrive/acpp/acpp_13_0/main.cpp
set splitbelow splitright
wincmd t
set winheight=1 winwidth=1
argglobal
...
25
normal! 032|
tabedit ~/OneDrive/acpp/acpp_13_0/Makefile
set splitbelow splitright
wincmd t
set winheight=1 winwidth=1
argglobal
