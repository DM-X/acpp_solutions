...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 48 - ((40 * winheight(0) + 34) / 69)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
48
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 19 - ((15 * winheight(0) + 34) / 69)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
19
...
8
normal! 019|
lcd ~/OneDrive/acpp/acpp_13_0_b
tabedit ~/OneDrive/acpp/acpp_13_0_b/Makefile
set splitbelow splitright
wincmd t
set winheight=1 winwidth=1
argglobal
